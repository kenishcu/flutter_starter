class MetaDataMedicalHistoryParentResult {
  ...
  MetaDataMedicalHistoryParentResult(this._results);
...
class MedicalHistoryResult {
  ...
  List<ServiceICD> _icds;

  MedicalHistoryResult(this._serviceId, this._serviceCode, this._serviceName, this._listPharmas, this._treatment, this._icds);

  factory MedicalHistoryResult.fromJson(dynamic json) {

    Treatment? treatment;

    List<ServiceICD> icds = [];
    if(json['service_icd'] != null && json['service_icd'].length > 0) {
      for (int i = 0; i < json['service_icd'].length; i++) {
        ServiceICD icd = ServiceICD.fromJson(json['service_icd'][i]);
        icds.add(icd);
      }
    }
    ...
    return MedicalHistoryResult(json['service_id'] as int, json['service_code'] as String, json['service_name'] as String, pharmas, treatment, icds);
  }

  List<ServiceICD> get icds => _icds;

  set icds(List<ServiceICD> value) {
    _icds = value;
  }
...
class Treatment{
  ...
  num get bmiNumber => _bmiNumber;

  set bmiNumber(num value) {
    _bmiNumber = value;
  }
  ...
  Treatment(this._benhSu, this._bmiNumber, this._canNang, this._chanDoan, this._chanDoanSoBo, this._chieuCao, this._huyetAp1, this._huyetAp2,
  ...
  factory  Treatment.fromJson(dynamic json) {
    ...
    //   return null;
    // }
    return Treatment(json['benh_su'] as String, json['bmi_number'] as num, json['can_nang'] as num, json['chan_doan'] as String, json['chan_doan_so_bo'] as String, json['chieu_cao'] as num,
...
class KetQuaKSK {
  ...
  factory KetQuaKSK.fromJson(dynamic json) {
    if(json != null && json is! List) {
      var keys = json.keys;
      String? ketQuaKhamCls;
      for (var kv in keys) {
        if (kv == "ket_qua_kham_cls") {
          ketQuaKhamCls = json[kv];
        }
      }
      return KetQuaKSK(ketQuaKhamCls);
    } else {
      return KetQuaKSK('');
    }
  }
...
class DetailPharma {
  ...
  List<PharmaIngredientDetail>? get pharmaIngredientDetails =>
      _pharmaIngredientDetails;

  set pharmaIngredientDetails(List<PharmaIngredientDetail>? value) {
    _pharmaIngredientDetails = value;
  }
...
//  WayToUseSelected _wayToUseSelected;
  ...
  DetailPharma(this._ingredient,  this._note, this._numberAfternoon, this._numberDay, this._numberMorning, this._numberNight,
      ...
      this._wayToUseName, this._unit, this._pharmaWayToUses, this._pharmaIngredientDetails);

  factory DetailPharma.fromJson(dynamic json) {
    List<PharmaWayToUse> pharmaWayToUses = [];
    List<PharmaIngredientDetail> pharmaIngredientDetail = [];
    // if(json == null) {
    //   return null;
    // }
    if(json["pharma_way_to_use"] != null && json["pharma_way_to_use"].length > 0) {
      for(int i = 0; i < json["pharma_way_to_use"].length; i++) {
        pharmaWayToUses.add(PharmaWayToUse.fromJson(json['pharma_way_to_use'][i]));
      }
    }

    if(json["pharma_ingredient_detail"] != null && json["pharma_ingredient_detail"].length > 0) {
      for(int i = 0; i < json["pharma_ingredient_detail"].length; i++) {
        pharmaIngredientDetail.add(PharmaIngredientDetail.fromJson(json['pharma_ingredient_detail'][i]));
      }
    }

    int? numDay;
    if( json['number_day'] is num) {
      numDay = json['number_day'];
    }

    if( json['number_day'] is String) {
      numDay = int.parse(json['number_day']);
    }
    ...
    return DetailPharma( Ingredient.fromJson(json['ingredient']), json['note'] as String, json['number_afternoon'] as num, numDay,
        json['number_morning'] as num, json['number_night'] as num, json['number_noon'] as num, json['pharma_category_id'] as dynamic,
        json['pharma_dosage'] as String,  json['pharma_dosage_detail'] as String, json['pharma_id'] as int,  json['pharma_name'] as String, quantity,
        json['supply_id'] as dynamic, json['way_to_use_name'] as String, Unit.fromJson(json['unit']), pharmaWayToUses, pharmaIngredientDetail);
  }
  ...
  List<PharmaWayToUse>? get pharmaWayToUses => _pharmaWayToUses;

  set pharmaWayToUses(List<PharmaWayToUse>? value) {
    _pharmaWayToUses = value;
  }
...
class Unit {
  ...
  Unit(this._active, this._isBasic, this._unitBasicExchange, this._unitBasicId, this._unitCode, this._unitId, this._unitName, this._uniNameEn, this._unitTypeId);

  factory Unit.fromJson(dynamic json) {
    return Unit(json['active'] as int, json['is_basic'] as int,  json['unit_basic_exchange'] as int, json['unit_basic_id'] as int,
        json['unit_code'] as String, json['unit_id'] as dynamic, json['unit_name'] as String, json['unit_name_en'] as String,
        json['unit_type_id'] as int);
  }

  int get isBasic => _isBasic;

  set isBasic(int value) {
    _isBasic = value;
  }

  int get unitBasicExchange => _unitBasicExchange;

  set unitBasicExchange(int value) {
    _unitBasicExchange = value;
  }

  int get unitBasicId => _unitBasicId;

  set unitBasicId(int value) {
    _unitBasicId = value;
  }
  ...
  String get uniNameEn => _uniNameEn;

  set uniNameEn(String value) {
    _uniNameEn = value;
  }

  int get unitTypeId => _unitTypeId;
...
class ServiceICD  {
  ...
  String _serviceCode;
  String _serviceDetailCode;

  ServiceICD(this._id, this._serviceCode, this._serviceDetailCode);

  factory ServiceICD.fromJson(dynamic json) {
    return ServiceICD(json['_id'] as String, json['service_code'] as String, json['service_detail_code'] as String);
  }
  ...
  String get serviceDetailCode => _serviceDetailCode;

  set serviceDetailCode(String value) {
    _serviceDetailCode = value;
  }
}