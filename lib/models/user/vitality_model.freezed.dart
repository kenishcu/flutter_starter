...
class _$VitalityModelTearOff {
  ...
  _VitalityModel call({List<VitalityDetailModel>? vitality}) {
...
mixin _$VitalityModel {
  List<VitalityDetailModel>? get vitality => throw _privateConstructorUsedError;
...
abstract class $VitalityModelCopyWith<$Res> {
  ...
  $Res call({List<VitalityDetailModel>? vitality});
}
...
class _$_VitalityModel extends _VitalityModel {
  _$_VitalityModel({this.vitality}) : super._();

  factory _$_VitalityModel.fromJson(Map<String, dynamic> json) =>
      _$$_VitalityModelFromJson(json);

  @override
  final List<VitalityDetailModel>? vitality;

  @override
  String toString() {
    return 'VitalityModel(vitality: $vitality)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(vitality));
...
abstract class _VitalityModel extends VitalityModel {
  factory _VitalityModel({List<VitalityDetailModel>? vitality}) =
      _$_VitalityModel;
  ...
  @override
  List<VitalityDetailModel>? get vitality;
  @override
  @JsonKey(ignore: true)
  _$VitalityModelCopyWith<_VitalityModel> get copyWith =>
      throw _privateConstructorUsedError;
