...
class AnimatedPharmaListWidget extends GetView<HomeController> {

  const AnimatedPharmaListWidget({Key? key}) : super(key: key);
              ...
              children: [
                const SizedBox(
                  ...
                  child: Align(
                    ...
                    child: Text("Lịch uống thuốc", style: TextStyle(
                        fontSize: 20,
