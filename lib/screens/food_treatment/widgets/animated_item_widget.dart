                              ...
                              children: [
                                Expanded(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                          item.product?.lang?['product_name_${Localizations.localeOf(context).languageCode}'] ?? item.product!.productName!,
                                      ...
                                      children: [
                                        Expanded(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Text("${AppLocalizations.of(context).getTranslate('price')} : " + formatPrice(0) + "/1Sp"),
                                          ),
                                        ),
                                        Expanded(
                                          flex: 2,
