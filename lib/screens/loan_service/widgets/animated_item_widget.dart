                      ...
                      children: [
                        Expanded(
                          ...
                          child: Container(
                            ...
                            child: Image.network("https://itrapp.hongngochospital.vn" + item.product!.imageUrl!),
                          ),
                        ),
                        Expanded(
                            flex: 2,
                  ...
                  children: [
                    Expanded(
                      ...
                      child: Container(
                        ...
                        width: 50,
                        height: double.infinity,
                        child: Image.network("https://itrapp.hongngochospital.vn" + controller.itemEs[index].product!.imageUrl!),
                      ),
                    ),
                    Expanded(
                        flex: 3,
                                ...
                                child: Row(
                                  children: [
                                    Expanded(
                                      ...
                                      child: Padding(
                                          padding: const EdgeInsets.all(0.0),
                                          child: Text(formatPrice(controller.itemEs[index].number! * controller.itemEs[index].product!.price!))
                                      ),
                                    ),
                                    Expanded(
                                        flex: 1,
